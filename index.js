...
var Viewer = /** @class */ (function () {
    ...
    Viewer.prototype.loadVim = function (fileName) {
        ...
        loader.load(fileName, function (vim) {
            ...
            for (var i = 0; i < vim.meshes.length; ++i) {
                _this.objects.push(vim.meshes[i]);
    ...
    Viewer.prototype.updateObjects = function () {
        ...
        this.scene.traverse(function (child) {
            if (child.isMesh && child !== _this.plane) {
                //child.castShadow = true;
                //child.receiveShadow = true;
                var scale = scalarToVec(_this.settings.object.scale);
                child.scale.copy(scale);
                child.position.copy(_this.settings.object.position);
                child.rotation.copy(toEuler(_this.settings.object.rotation));
            }
        });
    };
